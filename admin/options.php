		...
		<form id="dbem_options_form" method="post" action="">          
			...
			<div class="inside">
				<table class='form-table'>
                    ...
                    dbem_options_textarea ( __( 'Payment reminder email format', 'dbem' ), 'dbem_payment_reminder_email_body', __( 'The format of the email which will be sent to respondent when reminding him of an unpaid reservation. <br/>Use <code>#_RESPNAME</code> to display the name of the respondent.<br/>Use <code>#_CONTACTNAME</code> and <code>#_CONTACTEMAIL</code> a to display respectively the name and e-mail of the contact person.<br/>Use <code>#_COST</code> to display the events cost, and <code>#_BOOKINGPAYMENTLINK</code> to show a link to process the payment.', 'dbem' ) );
