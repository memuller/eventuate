...
function em_admin_help(){
	...
	<div class="wrap">
		...
		<p>
			If you require further support or encounter any bugs please visit us at our <a href="http://davidebenini.it/eventuate-forum/">Forum</a>. We ask that you give the documentation a good read first, as this answers many common questions.
		</p>
		<?php
		...
		if( $wpdb->get_var("SHOW TABLES LIKE '$old_table_name'") == $old_table_name ){
			...
			<div class="updated">
				...
				<ol>
					<li>First of all, <a href='http://downloads.wordpress.org/plugin/eventuate.2.2.2.zip'>dowload a copy of version 2.2</a></li>
