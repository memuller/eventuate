...
/**
 * Called by admin_print_scripts-(hook|page) action, created when adding menu items in eventuate.php
 */
function em_admin_load_scripts(){
	...
	//Time Entry
	wp_enqueue_script('em-timeentry', WP_PLUGIN_URL.'/eventuate/includes/js/timeentry/jquery.timeentry.js', array('jquery'));

	//Load the UI items, currently date picker and autocomplete plus dependencies
	//wp_enqueue_script('em-ui-js', WP_PLUGIN_URL.'/eventuate/includes/js/jquery-ui-1.8.5.custom.min.js', array('jquery', 'jquery-ui-core'));
	wp_enqueue_script('em-ui-js', WP_PLUGIN_URL.'/eventuate/includes/js/em_ui.js', array('jquery', 'jquery-ui-core'));

	//Date Picker Locale
	$locale_code = substr ( get_locale (), 0, 2 );
	$locale_file = "/eventuate/includes/js/i18n/jquery.ui.datepicker-$locale_code.js";
	...
	wp_enqueue_script('em-script', WP_PLUGIN_URL.'/eventuate/includes/js/em_admin.js', array('em-ui-js'));
...
/**
 * Called by admin_print_styles-(hook|page) action, created when adding menu items in eventuate.php
 */
function em_admin_load_styles() {
	wp_enqueue_style('em-ui-css', WP_PLUGIN_URL.'/eventuate/includes/css/jquery-ui-1.7.3.custom.css');
	wp_enqueue_style('eventuate-admin', WP_PLUGIN_URL.'/eventuate/includes/css/events_manager_admin.css');
}
